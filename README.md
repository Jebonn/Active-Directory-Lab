...
2. Click on "Use the following DNS server addresses" and enter the IP address of the Domain Controller. The alternate DNS server can be 8.8.8.8 which is Google's server.
3. 
